...
export default function Page() {
  ...
  // function convertPartOne(inputText) {
  //   let b = inputText;
  ...
  // function convertPartOneOfficialDispatch(inputText) {
  ...
  //     partOne = convertPartOneOfficialDispatch(contentInputText);

  //     partTwo = convertPartTwoOfficialDispatch(partOne);
  //   }else{
  //     partOne = convertPartOne(contentInputText);
  ...
  // async function getNormalTextInfo(roleSignText,lawRelatedText) {
  ...
  let data = [];
  // async function convertContent(contentOutputText) {
  //   data = [];
  ...
  // async function  convertContentOfficialDispatch(contentOutputText) {
